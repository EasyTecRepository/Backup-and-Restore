...
echo "<font color='blue'>backup of the "${DockerName_dumps_1}" database...</font>"
...
## Wait Dump 1 ##
echo "<font color='black'wait 5 seconds...</font>"
sleep 5

## Output: Script starts dump 2 ##
echo "<font color='blue'>backup of the "${DockerName_dumps_2}" database...</font>"
...
echo "<font color='blue'>backup of the "${DockerName_dumps_3}" database...</font>"
...
echo "<font color='blue'>backup of the "${DockerName_dumps_4}" database...</font>"
...
echo "<font color='blue'>backup of the "${DockerName_dumps_5}" database...</font>"
...
echo "<font color='blue'>backup of the "${DockerName_dumps_6}" database...</font>"
...
echo "<font color='blue'>backup of the "${DockerName_dumps_7}" database...</font>"
...
if [ -f "${mariadb_pfad_dump_user_1}"/${currentDate}_dump.sql ]
  then
    echo "<font color='green'>The "${DockerName1}" backup was successfully stored in the specified share.</font>"
  else
    echo "<font color='red'>ERROR: Something went wrong. The backup is not in the specified path!</font>"
fi
...
if [ -f "${mariadb_pfad_dump_user_2}"/${currentDate}_dump.sql ]
  then
    echo "<font color='green'>The "${DockerName2}" backup was successfully stored in the specified share.</font>"
  else
    echo "<font color='red'>ERROR: Something went wrong. The backup is not in the specified path!</font>"
fi
...
if [ -f "${mariadb_pfad_dump_user_3}"/${currentDate}_dump.sql ]
  then
    echo "<font color='green'>The "${DockerName3}" backup was successfully stored in the specified share.</font>"
  else
    echo "<font color='red'>ERROR: Something went wrong. The backup is not in the specified path!</font>"
fi
...
if [ -f "${mariadb_pfad_dump_user_4}"/${currentDate}_dump.sql ]
  then
    echo "<font color='green'>The "${DockerName4}" backup was successfully stored in the specified share.</font>"
  else
    echo "<font color='red'>ERROR: Something went wrong. The backup is not in the specified path!</font>"
fi
...
if [ -f "${mariadb_pfad_dump_user_5}"/${currentDate}_dump.sql ]
  then
    echo "<font color='green'>The "${DockerName5}" backup was successfully stored in the specified share.</font>"
  else
    echo "<font color='red'>ERROR: Something went wrong. The backup is not in the specified path!</font>"
fi
...
if [ -f "${mariadb_pfad_dump_user_6}"/${currentDate}_dump.sql ]
  then
    echo "<font color='green'>The "${DockerName6}" backup was successfully stored in the specified share.</font>"
  else
    echo "<font color='red'>ERROR: Something went wrong. The backup is not in the specified path!</font>"
fi
...
if [ -f "${mariadb_pfad_dump_user_7}"/${currentDate}_dump.sql ]
  then
    echo "<font color='green'>The "${DockerName7}" backup was successfully stored in the specified share.</font>"
  else
    echo "<font color='red'>ERROR: Something went wrong. The backup is not in the specified path!</font>"
fi
...
## Finalize mariadb dumps  ##
echo "<font color='green'>The MariaDB dumps have been saved.</font>"
