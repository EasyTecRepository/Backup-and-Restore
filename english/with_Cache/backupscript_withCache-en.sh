...
if [ -d "${mainPathCache}" ]
  then
    ...
    echo "<font color='red'>ERROR: Directory of "${mainPathCache}" does not exist! Abort...</font>"
...
sudo rsync --ignore-existing -az "${mainPathCache}" "${rsync_user}"@"${backupServerIP}":"${backupServerTargetPath}"
echo
